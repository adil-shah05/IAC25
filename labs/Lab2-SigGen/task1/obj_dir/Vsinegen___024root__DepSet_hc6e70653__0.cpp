...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    // Body
    __Vdly__sinegen__DOT__count = vlSelf->sinegen__DOT__count;
    vlSelf->dout = vlSelf->sinegen__DOT__rom1__DOT__rom_array
        [vlSelf->sinegen__DOT__count];
    if (vlSelf->rst) {
        __Vdly__sinegen__DOT__count = 0U;
    } else if (vlSelf->en) {
        __Vdly__sinegen__DOT__count = (0xffU & ((IData)(vlSelf->sinegen__DOT__count) 
                                                + (IData)(vlSelf->incr)));
    }
    vlSelf->sinegen__DOT__count = __Vdly__sinegen__DOT__count;
}
