The BCD converter should fix the problem of seeing the hex letters instead of a purely numerical display of the counter value. The testbench had to be amended for this to work.
